<i18n>
{
  "en": {
    ...
    "offersequipment": "Offers Devices/Materials",
    "lookingForequipment": "Devices/Materials needed",
  ...
  "de": {
    ...
    "offersequipment": "Geräte/Materialien anzubieten",
    "lookingForequipment": "Geräte/Materialien benötigt",
